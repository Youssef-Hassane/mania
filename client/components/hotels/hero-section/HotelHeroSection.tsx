...
export default function HotelHeroSection() {
  return (
    <section className="h-[700px] w-full flex flex-row  justify-center items-center text-center relative" style={{ backgroundImage: 'url(https://nyc3.digitaloceanspaces.com/hotelmania/Assets/5.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
